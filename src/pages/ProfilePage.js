...
const ProfilePage = () => {
    ...
    useEffect(() => {
        // If orders change and selectYear is not part of the new orders, reset selectedYear
        if (
            orders &&
            orders.length > 0 &&
            !orders.some((item) => item.year === selectedYear)
        ) {
                            ...
                            <div>
                                <div className="profile-page-order-main-div">
                                    ...
                                    {orders.map((item) => (
                                            ...
                                            <div key={item.id} className="profile-page-order-loop-div">
                                                ...
                                                {item.order_items.map(
                                                    (innerItem) => {
                                                        return (
                                                            <div>
                                                                <div key={innerItem.id} className="profile-page-order-detail-body">
                                                                    <img
